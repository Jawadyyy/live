                ...
                Expanded(
                  child:
                      filteredFriends.isEmpty
                          ...
                          : AnimatedList(
                            key: ValueKey(filteredFriends.length),
                            padding: const EdgeInsets.fromLTRB(16, 12, 16, 16),
                            initialItemCount: filteredFriends.length,
...
class _ChatListItemState extends State<_ChatListItem>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Map<String, dynamic>?>(
      future: messageService.getLastMessage(widget.friend['id']),
      builder: (context, lastMessageSnapshot) {
        ...
        return FutureBuilder<int>(
          future: messageService.getUnreadCount(widget.friend['id']),
          builder: (context, unreadSnapshot) {
            int unreadCount = 0;

            // Only show unread count for messages sent BY the friend TO you
            if (unreadSnapshot.hasData) {
              final count = unreadSnapshot.data ?? 0;
              // Only show if the last message was from the friend, not from you
              if (lastMessage != null &&
  ...
  Widget _buildMessageContent(
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            // Show "You: " prefix if you sent the last message
